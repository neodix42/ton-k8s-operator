...
```bash
export OPERATOR_IMG=ghcr.io/neodix42/ton-k8s-operator:0.1.12
...
```bash
wget -qO- "https://github.com/neodix42/ton-k8s-operator/releases/download/0.1.12/install.sh" | bash
```
